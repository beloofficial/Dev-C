...
.mod-lesson .progress_bar_completed {
    ...
    background-image: url(http://informatics.mccme.ru/mod/lesson/completed.gif);
...
.mod-lesson .progress_bar_todo {
    /*  Example Use of Image
    background-image: url(http://informatics.mccme.ru/mod/lesson/todo.gif);
    background-repeat: repeat-x;
    background-position: center;
    */
...
.mod-lesson .progress_bar_token {
    /*  Example Use of Image
    background-image: url(http://informatics.mccme.ru/mod/lesson/token.gif);
